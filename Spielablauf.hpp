...
public:
    ...
    int InFremdemZielfeld(int, int, int, Spieler, Spieler, Spieler, Spieler, Spielfeld); // Falls man sich in einem Fremden Zielfeld befindet, wird auf das Feld 4 draufgerechnet. Ansonsten wird das Feld zurueckgegeben, welches der Funktion uebergeben wurde.
